...
def main():
    try:
        ...
        processed_train = fill_missing_values_with_median(train_data)
        processed_test = fill_missing_values_with_median(test_data)

        save_data(processed_train, os.path.join(processed_data_path, 'train_processed_median.csv'))
        save_data(processed_test, os.path.join(processed_data_path, 'test_processed_median.csv'))
    except Exception as e:
